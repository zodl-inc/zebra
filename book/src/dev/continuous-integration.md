...
Adding a new Zebra crate automatically extends the `build` matrix in [test-crates.yml](https://github.com/zodl-inc/zebra/blob/main/.github/workflows/test-crates.yml); no manual step is required.
